...
p3 + scale_colour_distiller(palette="Spectral", direction=1)
```
...
ggplot(gapminder,aes(life_exp))+
  ...
  geom_histogram(aes(y=..density..,fill=continent),binwidth = 3)+ 
...
```{r}
color_layer<-scale_color_manual("",   #no title for legend
                                labels=c("Other Countries","Rwanda"),
                                values=c("black","red"))
ggplot(gapminder,aes(year,life_exp))+
  geom_line(aes(group=country,
                color=country=="Rwanda"),alpha=0.2)+
  color_layer
```
...
```{r}
color_layer<-scale_color_manual("",
                                labels=c("Other Countries","Rwanda"),
                                values=c("black","red"))
ggplot(gapminder,aes(year,life_exp))+
  geom_line(aes(group=country,
                color=country=="Rwanda",
